...
import { FrontendProjectsComponent } from "./components/frontend-projects/frontend-projects.component";
...
export const routes: Routes = [
    ...
    { path: 'frontend-projects', component: FrontendProjectsComponent, title: "Frontend" },
