...
## Corpus Check
- 518 files · ~134,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3371 nodes · 6484 edges · 252 communities (205 shown, 47 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e98ac01`
...
- `GameUrlsView` --references--> `GameUrl`  [EXTRACTED]
  SteamApp.Client/src/app/pages/game-url/game-urls-view/game-urls-view.ts → SteamApp.Client/src/app/models/game-url.model.ts
...
- `PixelsView` --references--> `PixelListItem`  [EXTRACTED]
  SteamApp.Client/src/app/pages/pixel/pixels-view/pixels-view.ts → SteamApp.Client/src/app/models/pixel.model.ts

## Import Cycles
- None detected.

## Communities (252 total, 47 thin omitted)
...
Cohesion: 0.06
Nodes (31): Directive, HostBinding, Status, CONSTANTS, formatMs(), ExternalLinkDirective, HostListener, Input (+23 more)

### Community 3 - "handleError"
Cohesion: 0.08
Nodes (16): Listing, WhishListResponse, ScrapeHistoryRerunResponse, ScrapeJobAccepted, CreateScrapingMode, ScrapingMode, UpdateScrapingMode, UpdateAdminUserRoleRequest (+8 more)

### Community 4 - "ScrapeHistoryDataService"
Cohesion: 0.19
Nodes (9): DateTime, ScrapeHistorySetupDto, ScrapeHistoryJob, ScrapeHistoryRerunSource, CancellationToken, DateTime, IReadOnlyList, Task (+1 more)
...
Cohesion: 0.07
Nodes (21): ConfirmDialogComponent, ConfirmDialogData, Component, CreateGame, Game, UpdateGame, UpdateGameStatus, CreateTag (+13 more)
...
Cohesion: 0.10
Nodes (24): SteamApp.WebAPI.Security, SteamApp.WebAPI.MinimalAPIs, SteamApp.IntegrationTests.Data, SteamApp.Tests.TestSupport, SteamApp.E2ETests.Repositories, SteamApp.WebAPI.Contracts.Pagination, SteamApp.Tests.Repositories, SteamApp.Application.Caching (+16 more)

### Community 9 - "ApplicationDbContext"
Cohesion: 0.06
Nodes (28): DbSet, EntityTypeBuilder, IdentityDbContext, IdentityRole, ModelBuilder, ApplicationDbContext, ICollection, Game (+20 more)
...
Cohesion: 0.16
Nodes (14): SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Consumers, SteamApp.WebAPI.Caching, SteamApp.WebAPI.MessageBrokers.Handlers.Wishlist, SteamApp.WebAPI.MessageBrokers.Abstractions, SteamApp.WebAPI.Jobs, SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Publishing, SteamApp.WebAPI.MessageBrokers.Handlers.Scraping, SteamApp.E2ETests.Services (+6 more)
...
Cohesion: 0.07
Nodes (21): SteamApp.Application.Utilities, SteamApp.Application.DTOs.WatchListItem, SteamApp.Application.DTOs.Game, SteamApp.Application.DTOs.WatchList, SteamApp.Application.Mapper, Profile, GameUpdateDto, GameUpdateStatusDto (+13 more)
...
Cohesion: 0.12
Nodes (17): AllowAnonymous, Authorize, ControllerBase, HttpDelete, HttpPut, IdentityUser, ModelStateDictionary, ApplicationUser (+9 more)
...
Cohesion: 0.27
Nodes (7): CancellationToken, HttpGet, HttpPost, IActionResult, IReadOnlyList, Task, SteamController
...
Cohesion: 0.16
Nodes (8): CancelAfter, IWebElement, IWebElement, Mock, Task, Test, TestCase, SteamServiceTests

### Community 39 - "WatchItemDto"
Cohesion: 0.24
Nodes (8): WatchItemDto, IEnumerable, IReadOnlyCollection, Task, FakeSteamService, IEnumerable, Task, ISteamService

### Community 40 - "SteamApp.Interfaces.Services"
Cohesion: 0.09
Nodes (14): SteamApp.Infrastructure.Services, SteamApp.WebAPI.Services, SteamApp.IntegrationTests.External, SteamApp.Application.DTOs.WishListItem, SteamApp.Application.DTOs.WatchItem, SteamApp.Interfaces.Repositories, SteamApp.Application.Services, SteamApp.Interfaces.Services (+6 more)
...
Cohesion: 0.25
Nodes (5): CancellationToken, Task, WishlistCheckMessageHandler, TimeSpan, RabbitMqOptions

### Community 44 - "WishlistJobIntegrationTests"
Cohesion: 0.23
Nodes (8): IDistributedCache, JsonSerializerOptions, MemoryDistributedCache, string, Task, Test, WishlistJobIntegrationTests, WishlistCheckRequested
...
Cohesion: 0.11
Nodes (9): SteamApp.Migrations, MigrationBuilder, ModelBuilder, AddAutomatedScrapeHistory, MigrationBuilder, ModelBuilder, AddFeedbackRequestHistory, MigrationBuilder (+1 more)
...
Cohesion: 0.17
Nodes (5): PasswordRequirement, ProfilePage, Component, UpdateUserProfileRequest, UserProfile
...
Cohesion: 0.25
Nodes (7): IAsyncDisposable, IConnection, CancellationToken, SemaphoreSlim, Task, ValueTask, RabbitMqConnection
...
Cohesion: 0.29
Nodes (7): BaseDto, GameCreateDto, GameDto, CancellationToken, List, Task, GameManager
...
Cohesion: 0.39
Nodes (3): IEnumerable, Task, SteamService
...
Cohesion: 0.09
Nodes (11): SteamApp.Application.DTOs.Product, SteamApp.WebApiClient.Managers, SteamApp.Application.DTOs.GameUrl, SteamApp.Application.DTOs.Pixel, SteamApp.IntegrationTests.MinimalApis, GameUrlUpdateDto, GameUrlUpdateStatusDto, PixelUpdateDto (+3 more)

### Community 120 - "ScrapeRequestedConsumer"
Cohesion: 0.15
Nodes (10): BackgroundService, ScrapeRequested, CancellationToken, JsonSerializerOptions, Task, ScrapeRequestedConsumer, CancellationToken, JsonSerializerOptions (+2 more)
...
### Community 142 - "db12"
Cohesion: 0.29
Nodes (3): MigrationBuilder, ModelBuilder, db12

### Community 143 - "SteamApp.WebAPI.Migrations"
Cohesion: 0.28
Nodes (4): SteamApp.WebAPI.Migrations, MigrationBuilder, ModelBuilder, db_v2

### Community 144 - "db_v21"
Cohesion: 0.29
Nodes (3): MigrationBuilder, ModelBuilder, db_v21

### Community 145 - "Migration"
Cohesion: 0.16
Nodes (6): Migration, MigrationBuilder, ModelBuilder, GameUrlName, MigrationBuilder, BackfillGameUrlScrapingModes
...
Cohesion: 0.27
Nodes (7): DateTime, AutomatedScrapeHistory, CancellationToken, IReadOnlyList, Task, IScrapeHistoryDataService, OwnedGameUrlSnapshot
...
Cohesion: 0.14
Nodes (10): Exception, CancellationToken, Task, TimeSpan, ScrapeRequestedMessageHandler, Exception, IMemoryCache, string (+2 more)
...
Cohesion: 0.31
Nodes (4): SteamApp.Domain.ValueObjects.Authentication, SteamApp.Tests.Security, SteamApp.Tests.Controllers, SteamApp.WebAPI.Controllers
...
Cohesion: 0.25
Nodes (8): DateTime, ScrapeHistoryDetailDto, IEnumerable, ScrapeHistoryRerunResponseDto, DateTime, ScrapeHistorySummaryDto, ScrapeJobAcceptedDto, ScrapeJobStatusEnum
...
### Community 235 - "OneShotHttpServer"
Cohesion: 0.25
Nodes (5): Task, ValueTask, OneShotHttpServer, TcpListener, Uri

### Community 237 - "AddFeedbackRequests"
Cohesion: 0.29
Nodes (3): MigrationBuilder, ModelBuilder, AddFeedbackRequests
...
### Community 245 - "IntegrationJwt"
Cohesion: 0.50
Nodes (3): DateTime, string, IntegrationJwt

## Knowledge Gaps
- **482 isolated node(s):** `$schema`, `version`, `newProjectRoot`, `projectType`, `style` (+477 more)
...
- `local-release` (3× useful, score=2.999129247)
- `AuthController` (2× useful, score=1.999697022)
- `.Login()` (2× useful, score=1.999697022)
- `browser` (2× useful, score=1.999389988)
- `Program.cs` (2× useful, score=1.998975705) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `SteamApp.Infrastructure.Context` connect `SteamApp.Infrastructure.Context` to `db12`, `SteamApp.WebAPI.Migrations`, `db_v21`, `Migration`, `EntitiesRework`, `WacthListIsActive`, `IsProductActive`, `ProductRating`, `ProductTags`, `FixProductsTag`, `GameInternalId_GameUrlPixelLocation`, `CustomWatchlistUrl`, `CustomWatchlistRework`, `AddScrapingModeToGameUrl`, `SeedScrapingModes`, `SyncModelChanges`, `AddUserProfileFields`, `AddUserOwnership`, `SteamApp.Interfaces.Services`, `SteamApp.Migrations`, `ApplicationDbContextModelSnapshot.cs`, `SteamControllerTests.cs`, `SteamApp.Domain.Enums`, `AddFeedbackRequests`, `MinimalApiCrudIntegrationTests.cs`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `SteamApp.Interfaces.Services` connect `SteamApp.Interfaces.Services` to `EmailService`, `SteamApp.Infrastructure.Context`, `ITransientRetryPolicyService`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `SteamApp.IntegrationTests.Support`, `IEmailSmtpClient`, `EncryptionHashingService`, `SteamControllerTests.cs`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `SteamAppFactory` connect `SteamAppFactory` to `EmailService`, `Program`, `WatchItemDto`, `SteamApp.Interfaces.Services`, `CapturingMessagePublisher`, `FakeWishlistService`, `.ResetDatabaseAsync`, `.CreateAuthenticatedClient`, `.CreateAnonymousClient`?**
