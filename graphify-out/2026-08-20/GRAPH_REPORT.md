# Graph Report - SteamApp  (2026-08-19)

## Corpus Check
- 574 files · ~166,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3968 nodes · 7925 edges · 285 communities (216 shown, 69 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 382 edges (avg confidence: 0.8)
...
- postcss
- tailwindcss
- 20260113211834_db1.2.Designer.cs
...
## Communities (285 total, 69 thin omitted)
...
Cohesion: 0.12
Nodes (18): Status, CONSTANTS, formatMs(), formatDuration(), ExternalLinkHostComponent, Component, makeEnumHelpers(), encode() (+10 more)
...
Cohesion: 0.08
Nodes (8): Tag, TagForm, Component, TagsView, Component, ViewChild, TagService, Injectable
...
Cohesion: 0.08
Nodes (10): CreateGameUrlPixel, GameUrlPixel, getErrorMessage(), handleError(), GameUrlPixelService, Injectable, ScrapingModeService, Injectable (+2 more)
...
Cohesion: 0.10
Nodes (19): SteamApp.WebAPI.Security, SteamApp.Domain.ValueObjects.Authentication, SteamApp.WebAPI.MinimalAPIs, SteamApp.Tests.Security, SteamApp.WebAPI.Contracts.Pagination, SteamApp.Infrastructure.Context, SteamApp.IntegrationTests.Security, SteamApp.WebAPI (+11 more)
...
Cohesion: 0.08
Nodes (23): IDictionary, JObject, AppData, IList, Asset, IList, AssetDetail, Description (+15 more)
...
Cohesion: 0.07
Nodes (20): SteamApp.Infrastructure.Services, SteamApp.WebAPI.Services, SteamApp.Tests.Controllers, SteamApp.IntegrationTests.External, SteamApp.Application.DTOs.WatchItem, SteamApp.Application.JsonObjects, SteamApp.Application.DTOs.ManualCheck, SteamApp.Interfaces.Services (+12 more)
...
Cohesion: 0.28
Nodes (7): CancellationToken, IEnumerable, Task, WishlistRepository, Task, Test, WishlistRepositoryTests
...
Cohesion: 0.18
Nodes (7): CancelAfter, IWebElement, Mock, Task, Test, TestCase, SteamServiceTests
...
Cohesion: 0.07
Nodes (14): SteamApp.Application.DTOs.Product, SteamApp.WebApiClient.Managers, SteamApp.Application.DTOs.GameUrl, SteamApp.Application.DTOs.Pixel, SteamApp.Application.DTOs.WishListItem, SteamApp.Application.Services, GameUrlUpdateDto, GameUrlUpdateStatusDto (+6 more)
...
Cohesion: 0.08
Nodes (14): SteamApp.WebAPI.Migrations, ModelSnapshot, ModelBuilder, db_v2, ModelBuilder, EntitiesRework, ModelBuilder, WacthListIsActive (+6 more)
...
Cohesion: 0.09
Nodes (19): Listing, WhishListResponse, CreateProductTag, ProductTag, ScrapeHistoryDetail, ScrapeHistoryRerunResponse, ScrapeJobAccepted, CreateScrapingMode (+11 more)
...
Cohesion: 0.15
Nodes (10): IConnection, IMessagePublisher, CancellationToken, SemaphoreSlim, Task, ValueTask, RabbitMqConnection, CancellationToken (+2 more)
...
Cohesion: 0.17
Nodes (10): SteamApp.Infrastructure, SteamApp.Models.OperationResults, ProductCreateDto, ProductDto, BaseOperationResult, ItemCreateResult, CancellationToken, List (+2 more)
...
### Community 104 - "xlsx"
Cohesion: 0.29
Nodes (9): EnableRateLimiting, CancellationToken, HttpDelete, HttpGet, HttpPost, HttpPut, IActionResult, Task (+1 more)
...
Cohesion: 0.14
Nodes (10): CancellationToken, Task, CancellationToken, Task, WishlistCheckMessageHandler, WishlistCheckRequested, CancellationToken, JsonSerializerOptions (+2 more)
...
Cohesion: 0.19
Nodes (18): DateTime, List, ManualCheckAssetMatchDto, ManualCheckConditionOperatorDto, ManualCheckCriterionDto, ManualCheckDescriptionMatchDto, ManualCheckProductErrorDto, ManualCheckProductInputDto (+10 more)
...
Cohesion: 0.15
Nodes (7): Migration, MigrationBuilder, db_v2, MigrationBuilder, AddUserOwnership, MigrationBuilder, ExtendAutomatedManualChecks
...
Cohesion: 0.36
Nodes (5): CancellationToken, IEnumerable, Task, IWishlistRepository, WishList
...
Cohesion: 0.12
Nodes (14): SteamApp.IntegrationTests.Data, SteamApp.Tests.TestSupport, SteamApp.Tests.Repositories, SteamApp.Application.Caching, SteamApp.Domain.Entities, SteamApp.Tests.MinimalApis, SteamApp.Infrastructure.Repositories, SteamApp.Interfaces.Repositories (+6 more)
...
Cohesion: 0.07
Nodes (22): CreateGameUrlProduct, GameUrlProduct, ManualCheckAssetMatch, ManualCheckConditionOperator, ManualCheckDescriptionMatch, ManualCheckPreset, ManualCheckPresetWrite, ManualCheckProductError (+14 more)
...
Cohesion: 0.09
Nodes (19): Channel, IAsyncEnumerable, Mock, Task, Test, ManualChecksControllerTests, Task, Test (+11 more)
...
### Community 230 - "AddScrapeHistoryJobStatus"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (6): IAsyncDisposable, Task, Uri, ValueTask, OneShotHttpServer, TcpListener
...
Cohesion: 0.17
Nodes (6): WebApplication, PixelEndpoints, WebApplication, ProductEndpoints, WebApplication, ScrapingModeEndpoints

### Community 257 - "ScrapingModeEndpoints"
Cohesion: 0.33
...
- **Why does `SteamApp.Infrastructure.Context` connect `SteamApp.Domain.Enums` to `Migration`, `20260120212257_game-url-name.Designer.cs`, `20260201104921_ProductTags.Designer.cs`, `20260201134450_FixProductsTag.Designer.cs`, `20260113211834_db1.2.Designer.cs`, `SteamApp.Application.JsonObjects`, `.MaterializeResultsIfNeeded`, `SteamApp.Migrations`, `ApplicationDbContextModelSnapshot.cs`, `SteamControllerTests.cs`, `PixelEndpoints`, `SecurityPolicies.cs`, `jasmine-core`, `OneShotHttpServer`, `AddFeedbackRequests`, `SteamApp.Application.DTOs.ScrapingMode`, `.attachTableControls`, `ISteamRepository`, `ChangePasswordRequest.cs`, `DeleteUserRequest.cs`, `20260515171509_AddUserOwnership.Designer.cs`, `20260627144144_AddFeedbackRequestHistory.Designer.cs`, `ScrapingMode`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `SteamApp.WebAPI.Services` connect `SteamApp.Application.JsonObjects` to `ProductTagsEndpoints`, `IWishlistNotificationRecipientService`, `SteamApp.Interfaces.Services`, `app.component.ts`, `.MaterializeResultsIfNeeded`, `ProductForm`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `SteamApp.Application.DTOs.ScrapingMode`, `SteamApp.Domain.Enums`, `SteamControllerTests.cs`, `PixelEndpoints`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `SteamApp.Domain.Entities` connect `SteamControllerTests.cs` to `AddUserOwnership`, `jasmine-core`, `WatchListsView`, `IdentitySchemaInitializer`, `AddScrapeHistoryJobStatus`, `.MaterializeResultsIfNeeded`, `SteamApp.Domain.Enums`, `SteamApp.Application.Mapper`, `WacthListIsActive`, `TestDb`, `PixelEndpoints`, `SteamApp.Application.JsonObjects`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
