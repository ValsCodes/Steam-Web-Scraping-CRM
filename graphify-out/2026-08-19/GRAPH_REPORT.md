...
## Corpus Check
- 574 files · ~166,135 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3968 nodes · 7925 edges · 284 communities (215 shown, 69 thin omitted)
...
## Communities (284 total, 69 thin omitted)
...
Cohesion: 0.06
Nodes (14): CreateGameUrlPixel, GameUrlPixel, CreateGameUrlProduct, GameUrlProduct, getErrorMessage(), handleError(), GameUrlPixelService, Injectable (+6 more)
...
Cohesion: 0.09
Nodes (22): SteamApp.WebAPI.Security, SteamApp.Domain.ValueObjects.Authentication, SteamApp.WebAPI.MinimalAPIs, SteamApp.Tests.Security, SteamApp.WebAPI.Contracts.Pagination, SteamApp.Infrastructure.Context, SteamApp.IntegrationTests.Security, SteamApp.WebAPI (+14 more)
...
Cohesion: 0.05
Nodes (28): SteamApp.Infrastructure.Services, SteamApp.Application.Utilities, SteamApp.WebAPI.Services, SteamApp.Tests.Controllers, SteamApp.IntegrationTests.External, SteamApp.Application.DTOs.ScrapeHistory, SteamApp.Domain.Enums, SteamApp.Application.DTOs.WatchItem (+20 more)
...
Cohesion: 0.08
Nodes (13): SteamApp.Application.DTOs.Product, SteamApp.WebApiClient.Managers, SteamApp.Application.DTOs.GameUrl, SteamApp.Application.DTOs.Pixel, SteamApp.Application.DTOs.Game, GameUpdateDto, GameUpdateStatusDto, GameUrlUpdateDto (+5 more)
...
Cohesion: 0.07
Nodes (15): SteamApp.Migrations, ModelBuilder, AddAutomatedScrapeHistory, ModelBuilder, AddFeedbackRequests, ModelBuilder, AddFeedbackRequestHistory, ModelBuilder (+7 more)

### Community 47 - "ApplicationDbContextModelSnapshot.cs"
Cohesion: 0.08
Nodes (14): SteamApp.WebAPI.Migrations, ModelSnapshot, ModelBuilder, db12, ModelBuilder, EntitiesRework, ModelBuilder, WacthListIsActive (+6 more)
...
Cohesion: 0.13
Nodes (15): Listing, WhishListResponse, ScrapeHistoryDetail, ScrapeHistoryRerunResponse, ScrapeJobAccepted, CreateScrapingMode, ScrapingMode, ScrapingModeEnum (+7 more)
...
Cohesion: 0.20
Nodes (8): SmtpClient, CancellationToken, MimeMessage, SecureSocketOptions, Task, ValueTask, IEmailSmtpClient, MailKitEmailSmtpClient
...
Cohesion: 0.17
Nodes (8): ManualCheckProductTrace, ManualCheckRunSummary, HistoryView, ManualCheckHistoryDialogComponent, ManualCheckHistoryDialogData, Component, ManualCheckSteamResultDialogComponent, Component
...
Cohesion: 0.29
Nodes (4): Queue, IEmailSmtpClientFactory, MailKitEmailSmtpClientFactory, FakeEmailSmtpClientFactory
...
Cohesion: 0.13
Nodes (3): ManualCheckRunDetail, ManualModeV2, Component
...
Cohesion: 0.15
Nodes (7): Migration, MigrationBuilder, db_v2, MigrationBuilder, WacthListIsActive, MigrationBuilder, AddScrapeHistoryJobStatus
...
Cohesion: 0.11
Nodes (15): SteamApp.IntegrationTests.Data, SteamApp.Tests.TestSupport, SteamApp.Tests.Repositories, SteamApp.Application.Caching, SteamApp.Domain.Entities, SteamApp.Tests.MinimalApis, SteamApp.Infrastructure.Repositories, SteamApp.Application.DTOs.WishListItem (+7 more)
...
- **Why does `SteamApp.Infrastructure.Context` connect `SteamApp.Domain.Enums` to `SteamApp.WebAPI.Migrations`, `Migration`, `20260120212257_game-url-name.Designer.cs`, `20260201104921_ProductTags.Designer.cs`, `20260201134450_FixProductsTag.Designer.cs`, `SteamApp.Application.JsonObjects`, `SteamApp.Migrations`, `ApplicationDbContextModelSnapshot.cs`, `SteamControllerTests.cs`, `SecurityPolicies.cs`, `ScrapeHistorySummaryDto`, `jasmine-core`, `OneShotHttpServer`, `AddFeedbackRequests`, `SteamApp.Application.DTOs.ScrapingMode`, `.attachTableControls`, `ISteamRepository`, `DeleteUserRequest.cs`, `20260515171509_AddUserOwnership.Designer.cs`, `20260627144144_AddFeedbackRequestHistory.Designer.cs`, `ScrapingMode`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `SteamApp.WebAPI.Services` connect `SteamApp.Application.JsonObjects` to `ProductTagsEndpoints`, `IWishlistNotificationRecipientService`, `SteamApp.Interfaces.Services`, `ProductForm`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `SteamApp.Application.DTOs.ScrapingMode`, `SteamApp.Domain.Enums`, `SteamControllerTests.cs`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `SteamApp.Domain.Entities` connect `SteamControllerTests.cs` to `jasmine-core`, `WatchListsView`, `IdentitySchemaInitializer`, `.CreateMemoryCache`, `AddScrapeHistoryJobStatus`, `.MaterializeResultsIfNeeded`, `SteamApp.Domain.Enums`, `SteamApp.Application.Mapper`, `WacthListIsActive`, `TestDb`, `SteamApp.Application.JsonObjects`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
