# Graph Report - SteamApp  (2026-09-13)

## Corpus Check
- 672 files · ~207,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4459 nodes · 9128 edges · 287 communities (215 shown, 72 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 482 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58ee326e`
...
1. `handleError()` - 122 edges
2. `ManualModeV2` - 84 edges
3. `SteamApp.Infrastructure.Context` - 72 edges
4. `SteamApp.Domain.Entities` - 72 edges
5. `AuthService` - 54 edges
6. `SteamApp.Domain.Enums` - 52 edges
7. `SteamApp.WebAPI.Migrations` - 52 edges
8. `GameService` - 51 edges
9. `SteamApp.Interfaces.Services` - 45 edges
10. `GameUrlForm` - 44 edges
...
Cohesion: 0.11
Nodes (10): SteamApp.E2ETests.Repositories, SteamApp.IntegrationTests.Security, SteamApp.E2ETests.MinimalApis, SteamApp.IntegrationTests.MinimalApis, SteamApp.E2ETests.Support, SteamApp.IntegrationTests.Support, SteamApp.Infrastructure.Identity, Task (+2 more)

### Community 2 - "ManualModeV2"
Cohesion: 0.06
Nodes (28): ManualCheckConditionOperator, ManualCheckCriterion, containsManualCheckGroup(), createFlatFallback(), createManualCheckCriterionNode(), createManualCheckGroupNode(), createNodeId(), ManualCheckExpressionEditorComponent (+20 more)

### Community 3 - "handleError"
Cohesion: 0.09
Nodes (16): CreateGame, Game, UpdateGame, UpdateGameStatus, GameForm, Component, HomePage, HomeSectionCard (+8 more)
...
Cohesion: 0.07
Nodes (16): SteamApp.Infrastructure.Services, SteamApp.WebAPI.Services, SteamApp.WebAPI.Jobs, SteamApp.WebAPI.ManualChecks, SteamApp.IntegrationTests.External, SteamApp.Application.DTOs.WishListItem, SteamApp.Application.JsonObjects, SteamApp.Application.DTOs.ManualCheck (+8 more)
...
Cohesion: 0.07
Nodes (27): @angular/cli, @angular/compiler-cli, @angular-devkit/build-angular, jest, jest-environment-jsdom, jest-preset-angular, karma-chrome-launcher, karma-coverage (+19 more)
...
Cohesion: 0.09
Nodes (19): SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Consumers, SteamApp.WebAPI.Caching, SteamApp.WebAPI.MessageBrokers.Handlers.Wishlist, SteamApp.WebAPI.MessageBrokers.Abstractions, SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Publishing, SteamApp.WebAPI.MessageBrokers.Handlers.Scraping, SteamApp.WebAPI.Scraping, SteamApp.E2ETests.Services (+11 more)

### Community 15 - "SteamApp.Domain.Enums"
Cohesion: 0.06
Nodes (18): CreateGameUrlPixel, GameUrlPixel, Listing, WhishListResponse, ManualCheckPreset, ManualCheckPresetWrite, ManualCheckRunAccepted, ManualCheckRunRequest (+10 more)

### Community 16 - "SteamApp.Application.Mapper"
Cohesion: 0.07
Nodes (11): CreateProduct, UpdateProduct, UpdateProductStatus, CreateProductTag, ProductTag, ProductForm, Component, ProductService (+3 more)
...
Cohesion: 0.11
Nodes (15): DbSet, EntityTypeBuilder, IDbContextFactory, IdentityDbContext, IdentityRole, IDisposable, ModelBuilder, ApplicationDbContext (+7 more)
...
Cohesion: 0.17
Nodes (6): DateTime, ManualCheckProductErrorDto, ManualCheckProductTraceDto, List, ManualCheckRunResultsDto, IReadOnlyCollection
...
Cohesion: 0.06
Nodes (17): SteamApp.Migrations, ModelBuilder, AddAutomatedScrapeHistory, ModelBuilder, AddFeedbackRequests, ModelBuilder, AddFeedbackRequestHistory, ModelBuilder (+9 more)
...
Cohesion: 0.40
Nodes (4): Task, Test, TestCase, GameUrlProductBulkIntegrationTests
...
Cohesion: 0.13
Nodes (12): ICollection, Game, GameAddOn, ICollection, int, ItemGroup, DateTime, ICollection (+4 more)
...
Cohesion: 0.13
Nodes (12): Minutes, Seconds, DateTime, ManualCheckRun, CancellationToken, ICollection, IEnumerable, int (+4 more)
...
Cohesion: 0.11
Nodes (9): Migration, MigrationBuilder, db12, MigrationBuilder, AddManualChecks, MigrationBuilder, AddManualCheckCriterionGroups, MigrationBuilder (+1 more)
...
Cohesion: 0.27
Nodes (7): Task, Test, GameUrlProductStockIntegrationTests, DateTime, string, IntegrationJwt, DateTime
...
Cohesion: 0.08
Nodes (17): ClaimsPrincipal, SteamApp.WebAPI.Exceptions, SteamApp.WebAPI.Security, SteamApp.Domain.ValueObjects.Authentication, SteamApp.Tests.Security, SteamApp.Tests.Controllers, SteamApp.WebAPI.Controllers, Exception (+9 more)
...
Cohesion: 0.05
Nodes (29): SteamApp.Application.Utilities, SteamApp.Application.DTOs.ScrapeHistory, SteamApp.Domain.Enums, SteamApp.Application.DTOs.FeedbackRequest, FeedbackRequestCreateDto, DateTime, FeedbackRequestDto, DateTime (+21 more)
...
Cohesion: 0.05
Nodes (27): SteamApp.WebAPI.MinimalAPIs, SteamApp.Application.DTOs.ItemGroup, SteamApp.Application.DTOs.Product, SteamApp.WebAPI.Contracts.AdminUsers, SteamApp.Tests.TestSupport, SteamApp.Infrastructure.Context, SteamApp.Application.DTOs.Pixel, SteamApp.Application.DTOs.Game (+19 more)
...
Cohesion: 0.07
Nodes (20): SteamApp.WebAPI.Contracts.Pagination, SteamApp.Application.DTOs.GameUrl, SteamApp.Tests.MinimalApis, GameUrlUpdateDto, GameUrlUpdateStatusDto, GamesPageQuery, GameUrlsPageQuery, int (+12 more)
...
Cohesion: 0.12
Nodes (9): SteamApp.Application.DTOs.GameUrlProduct, SteamApp.WebAPI.Contracts.GameUrlProduct, GameUrlProductBulkSyncDto, GameUrlProductCreateDto, GameUrlProductCurrentStockDto, GameUrlProductCurrentStockUpdateDto, GameUrlProductDto, int (+1 more)
...
### Community 256 - "TestDb"
Cohesion: 0.53
Nodes (4): DbContextOptions, InMemoryDatabaseRoot, string, TestDb

### Community 258 - "groupByItemGroup"
Cohesion: 0.12
Nodes (11): GroupableItem, groupByItemGroup(), ItemGroupSection, sortItems(), item(), getListingUrl(), ConfirmDialogComponent, ConfirmDialogData (+3 more)
...
Cohesion: 0.13
Nodes (10): ICollection, GameUrl, GameUrlProducts, ICollection, Product, ProductTags, ICollection, ScrapingMode (+2 more)
...
### Community 269 - "ManualCheckOptions"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (22): SteamApp.IntegrationTests.Data, SteamApp.Tests.Repositories, SteamApp.Application.Caching, SteamApp.Domain.Entities, SteamApp.Infrastructure.Repositories, SteamApp.Interfaces.Repositories, SteamApp.Application.Mapper, Profile (+14 more)

## Knowledge Gaps
- **635 isolated node(s):** `$schema`, `version`, `newProjectRoot`, `projectType`, `style` (+630 more)
...
- **Why does `SteamApp.Infrastructure.Context` connect `ProductEndpoints` to `web-scraper.component.ts`, `20260506092153_SeedScrapingModes.Designer.cs`, `ManualCheckHistoryDialogComponent`, `WebScraperComponent`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `WatchListEndpoints`, `20260207125824_GameInternalId_GameUrlPixelLocation.Designer.cs`, `Migration`, `WacthListIsActive`, `20260120212257_game-url-name.Designer.cs`, `IsProductActive`, `20260201104921_ProductTags.Designer.cs`, `.MaterializeResultsIfNeeded`, `SteamApp.Migrations`, `ApplicationDbContextModelSnapshot.cs`, `TagsEndpoints`, `WishListEndpoints`, `RabbitMqOptions`, `IntegrationJwt`, `SecurityPolicies.cs`, `.SwaggerIsExposedInDevelopmentAndHiddenBehindProductionApiSecurity`, `ScrapeHistorySummaryDto`, `TagsView`, `7. Common troubleshooting`, `ItemCreateResult.cs`, `jasmine-core`, `20260515171509_AddUserOwnership.Designer.cs`, `20260516144656_AddAutomatedScrapeHistory.Designer.cs`, `SteamApp.Application.DTOs.ScrapingMode`, `SteamApiClient`, `20260814162547_AddManualChecks.Designer.cs`, `20260819092817_ExtendAutomatedManualChecks.Designer.cs`, `ControllerSecurityMetadataTests`, `DeleteUserRequest.cs`, `20260627144144_AddFeedbackRequestHistory.Designer.cs`, `ScrapingMode`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `SteamApp.Interfaces.Services` connect `WebScraperComponent` to `EmailService`, `web-scraper.component.ts`, `WatchListsView`, `.MaterializeResultsIfNeeded`, `ProductForm`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `WacthListIsActive`, `EncryptionHashingService`, `WishListsView`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `SteamApp.Domain.Entities` connect `WishListEndpoints` to `web-scraper.component.ts`, `.CreateMemoryCache`, `ManualCheckHistoryDialogComponent`, `rxjs`, `GameUrl`, `WebScraperComponent`, `.MaterializeResultsIfNeeded`, `RabbitMqConnection`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `ScrapeHistorySummaryDto`, `WacthListIsActive`, `TagsEndpoints`, `TagsView`, `WishListForm`, `ItemCreateResult.cs`, `DeleteUserRequest.cs`, `ProductEndpoints`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Are the 103 inferred relationships involving `handleError()` (e.g. with `.getUsers()` and `.updateRole()`) actually correct?**
  _`handleError()` has 103 INFERRED edges - model-reasoned connections that need verification._
