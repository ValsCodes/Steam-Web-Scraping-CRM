...
## Corpus Check
- 550 files · ~150,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3730 nodes · 7458 edges · 262 communities (188 shown, 74 thin omitted)
...
## Communities (262 total, 74 thin omitted)
...
Cohesion: 0.17
Nodes (13): ExternalLinkHostComponent, Component, externalUrlWarning(), isTrustedExternalHost(), openableExternalUrl(), openSafeExternalUrl(), parseWebUrl(), safeExternalImageUrl() (+5 more)
...
Cohesion: 0.05
Nodes (22): CreateProduct, Product, UpdateProduct, UpdateProductStatus, CreateProductTag, ProductTag, CreateTag, Tag (+14 more)

### Community 4 - "ScrapeHistoryDataService"
Cohesion: 0.17
Nodes (10): DateTime, ScrapeHistorySetupDto, DateTime, AutomatedScrapeHistory, OwnedGameUrlSnapshot, CancellationToken, DateTime, IReadOnlyList (+2 more)
...
Cohesion: 0.08
Nodes (22): ConfirmDialogComponent, ConfirmDialogData, Component, CreateGame, Game, UpdateGame, UpdateGameStatus, GameForm (+14 more)
...
Cohesion: 0.18
Nodes (8): SteamApp.Interfaces, CancellationToken, Task, IJobService, CancellationToken, Task, TimeSpan, WishlistCheckJob

### Community 14 - "SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options"
Cohesion: 0.08
Nodes (27): SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Consumers, SteamApp.WebAPI.Caching, SteamApp.WebAPI.MessageBrokers.Handlers.Wishlist, SteamApp.WebAPI.MessageBrokers.Abstractions, SteamApp.WebAPI.Jobs, SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Publishing, SteamApp.Tests.Controllers, SteamApp.WebAPI.MessageBrokers.Handlers.Scraping (+19 more)

### Community 15 - "SteamApp.Domain.Enums"
Cohesion: 0.09
Nodes (27): SteamApp.WebAPI.Security, SteamApp.Domain.ValueObjects.Authentication, SteamApp.WebAPI.MinimalAPIs, SteamApp.Tests.Security, SteamApp.IntegrationTests.Data, SteamApp.Tests.TestSupport, SteamApp.E2ETests.Repositories, SteamApp.WebAPI.Contracts.Pagination (+19 more)

### Community 16 - "SteamApp.Application.Mapper"
Cohesion: 0.06
Nodes (24): SteamApp.Application.Utilities, SteamApp.Application.DTOs.WatchListItem, SteamApp.Application.DTOs.ScrapingMode, SteamApp.Application.DTOs.WatchList, SteamApp.Application.Mapper, Profile, ScrapingModeCreateDto, ScrapingModeDto (+16 more)
...
Cohesion: 0.11
Nodes (16): IDictionary, Action, AppData, IList, AssetDetail, Description, Dictionary, IList (+8 more)
...
Cohesion: 0.06
Nodes (22): SteamApp.WebAPI.Services, SteamApp.Application.DTOs.ScrapeHistory, SteamApp.Domain.Enums, SteamApp.Application.JsonObjects, SteamApp.Application.DTOs.ManualCheck, IList, Asset, AssetDescription (+14 more)
...
Cohesion: 0.11
Nodes (14): CancellationToken, ConcurrentQueue, IReadOnlyCollection, Task, CapturingEmailService, CancellationToken, string, Task (+6 more)
...
Cohesion: 0.11
Nodes (10): SteamApp.Infrastructure.Services, SteamApp.IntegrationTests.External, SteamApp.Application.DTOs.WatchItem, SteamApp.Interfaces.Repositories, SteamApp.Interfaces.Services, SteamApp.Tests.Services, IEnumerable, ScrapeHistoryRerunResponseDto (+2 more)
...
Cohesion: 0.19
Nodes (9): SteamApp.WebAPI.Jobs.Base, PeriodicTimer, CancellationToken, SemaphoreSlim, string, Task, BackgroundWorkerService, TimeSpan (+1 more)
...
Cohesion: 0.06
Nodes (16): CreateGameUrlPixel, GameUrlPixel, CreateGameUrlProduct, GameUrlProduct, CreateScrapingMode, ScrapingMode, UpdateScrapingMode, handleError() (+8 more)

### Community 58 - "TestDb"
Cohesion: 0.05
Nodes (34): DbSet, EntityTypeBuilder, IDbContextFactory, IdentityDbContext, IdentityRole, ModelBuilder, ApplicationDbContext, IServiceProvider (+26 more)
...
Cohesion: 0.08
Nodes (5): xlsx, GamesView, Component, ViewChild, xlsx
...
Cohesion: 0.15
Nodes (9): IOptions, Queue, ILogger, EmailService, IEmailSmtpClientFactory, MailKitEmailSmtpClientFactory, Exception, ITransientRetryPolicyService (+1 more)
...
Cohesion: 0.17
Nodes (6): Status, CONSTANTS, formatMs(), getListingUrl(), makeEnumHelpers(), encode()
...
Cohesion: 0.15
Nodes (13): ManualCheckCriterionDto, ManualCheckPresetDto, ManualCheckPresetWriteDto, Task, Test, ManualCheckDataServiceTests, CancellationToken, IEnumerable (+5 more)
...
Cohesion: 0.17
Nodes (10): RetryConditionHeaderValue, CancellationToken, Task, IManualCheckExecutionService, CancellationToken, HttpStatusCode, Task, TimeSpan (+2 more)
...
Cohesion: 0.29
Nodes (4): CancellationToken, IReadOnlyList, Task, IManualCheckDataService
...
Cohesion: 0.18
Nodes (8): DateTime, ICollection, int, ManualCheckPreset, DateTime, ManualCheckRun, ManualCheckMatchModeEnum, ManualCheckRunStatusEnum

### Community 189 - "GameUrlPixelsEndpoints"
Cohesion: 0.07
Nodes (24): ManualCheckAssetMatch, ManualCheckDescriptionMatch, ManualCheckMatchMode, ManualCheckPreset, ManualCheckPresetWrite, ManualCheckProductError, ManualCheckProductInput, ManualCheckProductResult (+16 more)
...
- **Why does `SteamApp.Infrastructure.Context` connect `SteamApp.Domain.Enums` to `DeleteUserRequest.cs`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `Migration`, `GameUrlsView`, `SteamApp.Application.JsonObjects`, `SteamApp.Migrations`, `ApplicationDbContextModelSnapshot.cs`, `home-page.ts`, `IWishlistNotificationRecipientService`, `WishListEndpoints`, `SecurityPolicies.cs`, `pricing-page.ts`, `ScrapeHistorySummaryDto`, `.CreateService`, `OneShotHttpServer`, `AddFeedbackRequests`, `SteamApp.Application.DTOs.ScrapingMode`, `.attachTableControls`, `IntegrationJwt`, `ISteamRepository`, `ControllerSecurityMetadataTests`, `DeleteUserRequest.cs`, `20260515171509_AddUserOwnership.Designer.cs`, `20260627144144_AddFeedbackRequestHistory.Designer.cs`, `ScrapingMode`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `SteamApp.WebAPI.Security` connect `SteamApp.Domain.Enums` to `ClaimsPrincipalExtensions.cs`, `SecurityHeadersMiddlewareExtensions.cs`, `SecurityPolicies.cs`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `SteamApp.Application.JsonObjects`, `.ReadRequiredJsonAsync`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `SteamApp.Domain.Enums` connect `SteamApp.Application.JsonObjects` to `ScrapeHistoryDataService`, `SteamApp.Interfaces.Services`, `.MaterializeResultsIfNeeded`, `SteamApp.WebAPI.MessageBrokers.Providers.RabbitMq.Options`, `SteamApp.Domain.Enums`, `CheckboxesFilterComponent`, `AutomatedScrapeHistory`, `GameEndpoints`, `GameUrlsView`?**
